            ...
            <tbody>
                ...
                @foreach ($subcategories as $subcategory)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-center">
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('admin.subcategories.edit', $subcategory) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                Editar
                            </a>
                        </td>
                    </tr>
