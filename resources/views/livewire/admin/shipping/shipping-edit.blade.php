<div>
                ...
                <div class="card">
                    <div class="mb-4 flex flex-wrap -mx-2">
                        <div class="px-2">
                            ...
                            <x-input id="method-{{ $index }}" class="w-full"
                    ...
                    @if ($shipp->shipping_method->id != 1)
                        ...
                        <div class="flex justify-start">
                            <x-button class="">Actualizar Datos de Envío</x-button>
                        </div>
                    @endif
    ...
    @else
        <div class="flex items-center p-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400"
            ...
            <div>
                <span class="font-medium">Info alert!</span> No hay envíos programados para esta Orden
            </div>
        </div>
    @endif
